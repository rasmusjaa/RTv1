...
/*   Updated: 2020/05/29 22:56:22 by rjaakonm         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int		mlx_start(t_mlx *mlx)
{
	...
	mlx_hook(mlx->win_ptr, 5, (1L << 3), mouse_release, mlx);
	mlx_hook(mlx->win_ptr, 6, (1L << 6), mouse_move, mlx);
	mlx_hook(mlx->win_ptr, 9, (1L << 21), handle_expose, mlx);
	mlx_hook(mlx->win_ptr, 17, (1L << 17), exit_free, mlx);
